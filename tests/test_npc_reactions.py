...
from src.game.npc_reactions import (
    ...
    VELHO_NOX_DEFEATED_SHADOW_CONSEQUENCE_ID,
    VELHO_NOX_DEFEATED_SHADOW_CONSEQUENCE_TEXT,
...
def test_velho_nox_dialogue_after_defeated_shadow_has_priority_over_whisper() -> None:
    save = GameSave(
        id=DEFAULT_SAVE_ID,
        character_id="miko-meu",
    ...
    assert dialogue == VELHO_NOX_AFTER_DEFEATED_SHADOW_DIALOGUE
...
def test_apply_npc_interaction_effects_after_defeated_shadow_adds_consequence_once() -> None:
    save = GameSave(
        id=DEFAULT_SAVE_ID,
        character_id="miko-meu",
        story_flags=[ENTRY_WHISPER_HEARD_FLAG],
